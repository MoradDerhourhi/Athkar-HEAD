...
public class AdkarProvider implements RemoteViewsService.RemoteViewsFactory {

    Context context =null;

    public AdkarProvider(Context context) {
    ...
    public RemoteViews getViewAt(int position) {
        ...
        Intent updateWidgetIntent = new Intent(context, AdkarWidget.class);
        updateWidgetIntent.setAction(AppWidgetManager.ACTION_APPWIDGET_UPDATE);

        Intent viewIntent = new Intent(context, DailyAdkarActivity.class);
