...
public class AdkarWidget extends AppWidgetProvider{
    ...
    public void onUpdate(Context context, AppWidgetManager appWidgetManager,
        ...
        for(int currentWidgetId: appWidgetIds){
            ComponentName widget = new ComponentName(context, AdkarWidget.class);
            appWidgetManager.updateAppWidget(widget, new AdkarProvider(context).getViewAt(currentWidgetId));
